...
const BestSellersCard = ({image, price, offerPrice, discount, tital}:BestSellersCardProps) => {
  return (
    ...
    <div className="category uppercase truncate text-[0.8em] font-semibold text-blue-500 pt-1 pb-0 px-1 hover:cursor-pointer">{tital}</div>
